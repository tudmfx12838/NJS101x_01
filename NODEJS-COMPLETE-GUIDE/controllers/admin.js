...
exports.postAddProduct = (req, res, next) => {
  ...
  const image = req.file; //changed name from view
  ...
  const imageUrl = image.path; //Mongodb khong the luu file nen lay path cua image duoc luu tru o owner db

  const product = new Product({
    // _id: mongoose.Types.ObjectId('61dedcf613171fe821a8104b'),
    title: title,
    price: price,
    description: description,
    imageUrl: imageUrl,
  ...
  product
    ...
    .catch((err) => {
      ...
      //   validationErrors: [] //red boder for input error, in this case we dont need
      // });
      // res.redirect('/500');
